...
@Component({
  selector: 'app-ver-esquemas',
  templateUrl: './ver-esquemas.component.html',
})

export class VerEsquemasComponent implements OnInit {
  ...
  constructor(private ModuloService: RepoEsquemaService, private router: Router,
