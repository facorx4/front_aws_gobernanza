...
@Component({
  ...
  templateUrl: './detalleentidadBusqueda.component.html',

})
export class DetalleentidadBusquedaComponent implements OnInit {
          ...
          datos => {
            ...
            datos.reportes.map(x => {
              this.reportesService.getOne(x)
                .subscribe(data => {
                  this.selectedReporte.push({ nombre: data.nombre, id: data._id });
                })
            })
