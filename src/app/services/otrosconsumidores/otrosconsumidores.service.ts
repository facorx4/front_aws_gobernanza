...
import { OtrosConsumidoresModel as ServiceModel } from 'src/app/models/otrosconsumidores.model';

@Injectable({
  providedIn: 'root'
})

export class OtrosConsumidoresService {

    url = environment.url+'entidad/otroconsumidor/';
